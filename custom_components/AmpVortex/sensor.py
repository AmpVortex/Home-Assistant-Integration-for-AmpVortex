...
class AmpVortexSensorBase(CoordinatorEntity, SensorEntity):
...
class SignalStrength(AmpVortexSensorBase):
...
class ConnectionType(AmpVortexSensorBase):
...
class SSID(AmpVortexSensorBase):
    """SSID sensor"""
...
class Uptime(AmpVortexSensorBase):
    """Uptime sensor"""
...
class CpuUsage(AmpVortexSensorBase):
    """CPU Usage sensor"""
...
class DiskUsage(AmpVortexSensorBase):
    """Disk Usage sensor"""
...
class RamUsage(AmpVortexSensorBase):
    """RAM Usage sensor"""
